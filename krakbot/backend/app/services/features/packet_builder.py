...
def build_feature_packet(coin: str, mode: str, market_snapshot: dict, features: dict, ml_scores: dict, policy_context: dict, wallet_summary: dict | None = None, news_summary: dict | None = None) -> FeaturePacket:
    return FeaturePacket(
        ...
        optional_signals={"wallet_summary": wallet_summary, "news_summary": news_summary, "social_summary": None},

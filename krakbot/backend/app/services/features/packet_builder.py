...
def build_feature_packet(coin: str, mode: str, market_snapshot: dict, features: dict, ml_scores: dict, policy_context: dict, wallet_summary: dict | None = None, news_summary: dict | None = None, community_summary: dict | None = None, feature_engine_status: dict | None = None) -> FeaturePacket:
    return FeaturePacket(
        ...
        optional_signals={"wallet_summary": wallet_summary, "news_summary": news_summary, "social_summary": None, "community_summary": community_summary, "feature_engine_status": feature_engine_status},

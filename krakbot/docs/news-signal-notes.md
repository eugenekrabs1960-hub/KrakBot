...
- Community heat signal uses CoinGecko trending data. `community_bias_score` is a lightweight proxy derived from trending context, not full social sentiment analysis.
